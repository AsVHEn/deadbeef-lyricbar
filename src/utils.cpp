...
void update_lyrics(void *tr) {
	...
	if (artist && title) {
		...
		if (syncedfound == true){
			...
			std::cout << "syncedlyrics: " << syncedlyrics << "\n";
			chopset_lyrics(track, *lyrics);
